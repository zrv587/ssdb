...
public class FdfsDemo {
    public static void main(String[] args) {
        ...
        String[] strings = getStorageClient().upload_file("C:\\Users\\Administrator\\Desktop\\杨幂.jpg", "jpg", null);
        for (String str: strings ) {
            System.out.println(str);
        }

       int i= downloadFile("group1","M00/00/00/wKgABFssufCAbI42AATU3yDSBmo385.jpg",new File("S.jpg"));
